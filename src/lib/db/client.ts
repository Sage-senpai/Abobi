...
async function buildLawyer(walletAddress: string): Promise<Lawyer | null> {
  ...
  return {
    ...
    isDemo: typeof meta?.isDemo === "boolean" ? meta.isDemo : undefined,
    personaPrompt: typeof meta?.personaPrompt === "string" ? meta.personaPrompt : undefined,
